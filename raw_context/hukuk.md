# Avukat Ofis Yönetim Sistemi · Ana Rehber

Bu doküman, Avukat Ofis Yönetim Sistemi gereksinimlerinin **index dosyası**dır. Tüm ayrıntılı içerik `docs/` dizini altındaki modüler `.md` dosyalarına taşınmıştır. Bu rehber, hangi bölümün hangi dosyada yer aldığını ve nasıl kullanılacağını özetler.

## 1. Dosya Yapısı Genel Bakış

| Yol | Açıklama |
|---|---|
| `docs/01-ozellik-analizi.md` | Bölüm 1 – Özellik analizi, kapsam, tasarım kararları |
| `docs/02-proje-plani.md` | Bölüm 2 – Proje planı, modül bazlı kapsam |
| `docs/03-veri-modeli.md` | Bölüm 3 – Veri modeli özeti |
| `docs/04-onceliklendirme.md` | Bölüm 4 – Uygulama önceliklendirme planı |
| `docs/05-user-stories/parca-1-kullanici-yetki.md` | Parça 1 – Kullanıcı & yetki yönetimi user story'leri |
| `docs/05-user-stories/parca-2-muvekkil.md` | Parça 2 – Müvekkil yönetimi user story'leri |
| `docs/05-user-stories/parca-3-dosya-dava.md` | Parça 3 – Dosya/dava yönetimi user story'leri |
| `docs/05-user-stories/parca-4-gorev.md` | Parça 4 – İş listesi & görev yönetimi user story'leri |
| `docs/05-user-stories/parca-5-mali-takip.md` | Parça 5 – Mali takip user story'leri |
| `docs/05-user-stories/parca-6-raporlama.md` | Parça 6 – Raporlama & dashboard user story'leri |
| `docs/06-ozet.md` | Bölüm 6 – Özet, tamamlanan kapsam tablosu |

## 2. Bölüm Referansları

- **Bölüm 1 – Özellik Analizi:** `docs/01-ozellik-analizi.md`
- **Bölüm 2 – Proje Planı:** `docs/02-proje-plani.md`
- **Bölüm 3 – Veri Modeli Özeti:** `docs/03-veri-modeli.md`
- **Bölüm 4 – Uygulama Önceliklendirme:** `docs/04-onceliklendirme.md`
- **Bölüm 5 – User Stories:** `docs/05-user-stories/` altındaki altı parça dosyası
- **Bölüm 6 – Özet:** `docs/06-ozet.md`

Her user story dosyasında aşağıdaki başlıklar bulunur:

- **User Story** tanımı
- **Acceptance Criteria** tablosu
- **Negative Cases** tablosu
- **Edge Cases** tablosu

## 3. Kullanım Talimatı

1. İlgili modülü düzenlerken sadece ilgili `.md` dosyasını açın.
2. Yeni user story veya gereksinim eklemeleri için doğru parça dosyasını kullanın.
3. Dosya yapısında değişiklik yapmak istediğinizde önce bu rehberi güncelleyin.
4. Tam metne ihtiyaç duyduğunuzda `hukuk.md.backup` dosyasını referans alın.

## 4. Gelecek Adımlar

- Modül bazlı versiyonlama/günlükler eklenebilir.
- `docs/assets/` gibi destek klasörleri oluşturularak görseller veya diyagramlar saklanabilir.
- Bu yapıdan otomatik PDF/HTML üretmek için scriptler eklenebilir.

---

Bu dosya, Avukat Ofis Yönetim Sistemi dokümantasyonunun merkezî referansıdır. Tüm güncellemeler burada özetlenmeli ve ilgili modüler dosyalara bağlantılar korunmalıdır.
